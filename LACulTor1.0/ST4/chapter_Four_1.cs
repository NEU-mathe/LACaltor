...
namespace LACulTor1._0.ST4
{
    class chapter_Four_1
    {
        ...
        {
            this.xmldocument.Load("XML/Cal_4_1.xml");
            if (isRegeneration)
            {
                ...
                this.s = random.Next(0, 2);
                this.t = random.Next(0, 2);
            ...
            {
                XmlNode node = LoadXml.LoadShowParameterXml("Params_Cal_4_1.xml");
            ...
            {
                Console.WriteLine("2 α1α2");
            }
            if ((this.s == 0) && (this.t == 1))
            {
                Console.WriteLine("3 α1α2α3");
            }
            if ((this.s == 1) && (this.t == 0))
            {
                Console.WriteLine("3 α1α2α4");
            }
            if ((this.s == 1) && (this.t == 1))
            {
                Console.WriteLine("4 α1α2α3α4");
            }
