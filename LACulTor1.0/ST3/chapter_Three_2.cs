...
namespace LACulTor1._0.ST3
{
    class chapter_Three_2
    {
        ...
        private int c;
        private int d;
        private int ans1, ans2, ans3, ans4, _coe;

        public void Generate_T(string number, bool isRegeneration)
        {
            this.xmldocument.Load("XML/Cal_3_2.xml");
            if (isRegeneration)
            {
                do
                {
            ...
            {
                XmlNode node = LoadXml.LoadShowParameterXml("Params_Cal_3_2.xml");
            ...
            ans1 = ((this.a * this.a11) - (this.b * this.a21)) + (this.d * this.a31);
            ans2 = ((this.a * this.a12) - (this.b * this.a22)) + (this.d * this.a32);
            ans3 = ((this.a * this.a13) - (this.b * this.a23)) + (this.d * this.a33);
            ans4 = ((this.a * this.a14) - (this.b * this.a24)) + (this.d * this.a34);
            _coe = this.a + this.b - this.c;
            
            Console.WriteLine("1/{0}*{1}", this._coe, this.ans1);
            Console.WriteLine("1/{0}*{1}", this._coe, this.ans2);
            Console.WriteLine("1/{0}*{1}", this._coe, this.ans3);
            Console.WriteLine("1/{0}*{1}", this._coe, this.ans4);
        }
