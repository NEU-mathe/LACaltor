...
namespace LACulTor1._0.ST3
{
    class chapter_Three_6
    {
        ...
        {
            this.xmldocument.Load("XML/Cal_3_6.xml");
            if (isRegeneration)
            {
                this.c11 = 1;
                this.c22 = 1;
                ...
                this.l = this.numberTools.myRandom(6);
                this.m = this.numberTools.myRandom(6);
                this.n = this.numberTools.myRandom(6);
            ...
            {
                XmlNode node = LoadXml.LoadShowParameterXml("Params_Cal_3_6.xml");
            ...
            Console.WriteLine(this.markChange2(this.l) + "" + this.markChange1(this.m) + "" + this.markChange1(this.n));
        }
